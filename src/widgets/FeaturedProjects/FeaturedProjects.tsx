...
const featuredProjects = [
  ...
  },
  {
    ...
    isOwner: true,
    period: '2026 - Present',
    description: 'A self-populating community platform that discovers content via AI search, enriches it automatically, and generates its own social media presence from platform data.',
    myContributions: [
      'Built the entire platform from scratch, including the public site, user dashboards, and admin operations',
      'Designed automated content pipelines: business discovery, AI-powered event search, social media generation',
      'Developed the core listings architecture for 8 content verticals with unified entity patterns',
      'Built content generation system that turns platform data into Instagram stories and carousels automatically',
      'Set up quality pipelines with Playwright E2E and Sentry monitoring',
    ],
    clientResults: [
      '200+ listings on day one — platform launched with content, not empty',
      'Zero content team: discovery, enrichment, and social media run autonomously',
      'Consistent social media presence generated from live platform data',
    ],
