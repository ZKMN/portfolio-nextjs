...
export const REPOSITORIES: Repository[] = [
  ...
  },
  {
    ...
    responsibility: 'The internal operations hub and AI content engine. Beyond managing bookings, payments, and studio configurations, it powers an AI-assisted editorial pipeline -editors curate topics, AI generates research-grounded articles, and the team reviews before publication across 5 countries.',
    ...
    keyFeatures: [
      ...
      'Editorial calendar: ~14 topics/week across 5 countries, curated by editors with AI-assisted discovery',
...
export const FLOWS: Flow[] = [
  ...
  },
  {
    ...
    subtitle: 'AI generates content, editors control what gets published',
    steps: [
      { step: 1, text: 'Tavily discovers trending topics via web research, filtered by country market and zone rotation -editors can also create topics manually' },
      { step: 2, text: 'Editors curate and assign topics to countries across 6 content formats: SEO Evergreen, Weekly Digest, Man Series, FAQ, Zone-based (~14/week)' },
      ...
      { step: 6, text: 'Editors review generated content, edit if needed, and publish -articles flow to 5 Country Sites via API with ISR' },
    ],
    color: '#f59e0b',
  },
];
...
export const DECISIONS: Decision[] = [
  ...
  {
    title: 'AI-assisted editorial engine: ~70 articles/week across 5 countries',
    ...
    effect: 'Reduced editorial effort from full-time writing to curation and review. 6 content formats, zone-aware rotation to prevent repetition, medical safety filters with circuit breaker, cost tracking per article. Editors control topic selection and publication -AI handles the heavy lifting.',
  },
];
...
export const OUTCOME_GROUPS: OutcomeGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'AI editorial engine: trend discovery → GPT-5 generation → medical safety → editor review → publication, ~70 articles/week',
  ...
  },
  {
    ...
    items: [
      ...
      'AI-powered editorial pipeline across 5 countries: 6 formats, zone rotation, cost tracking, hero image generation -editors curate and publish',
